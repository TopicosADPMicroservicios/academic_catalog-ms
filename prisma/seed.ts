...
const maestroDeOferta = [
  ...
  {
    id: '9d1f2e3c-4b5a-6789-abcd-ef1234567890',
    periodoId: 'e98c933f-d706-4bdc-bdf8-755ea315b0eb',
    estudianteId: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
  },
  {
    id: '5e6f7a8b-9c0d-1234-efab-567890123456',
    periodoId: 'e98c933f-d706-4bdc-bdf8-755ea315b0eb',
    estudianteId: '123e4567-e89b-12d3-a456-426614174000',
  },
  {
    id: '6f7a8b9c-0d1e-2345-fabc-678901234567',
    periodoId: 'e98c933f-d706-4bdc-bdf8-755ea315b0eb',
    estudianteId: '987fcdeb-51a2-43d7-8f9e-123456789abc',
  },
  {
    id: '7a8b9c0d-1e2f-3456-abcd-789012345678',
    periodoId: 'e98c933f-d706-4bdc-bdf8-755ea315b0eb',
    estudianteId: 'abc12345-def6-789a-bcde-f123456789ab',
  },
];
...
const ofertaGrupoMateria = [
  ...
  },
  {
    ...
    grupoMateriaId: 'f4e5d6c7-b8a9-0b1c-2d3e-4f5a6b7c8d91',
    maestroDeOfertaId: '80be2bf8-efac-4adc-afcd-36e166fc17f0',
  },
  {
  ...
  // Ofertas para Maria
  {
    ...
    grupoMateriaId: '49ba5aaa-8217-4ea7-a6ef-ab55aaaed941',
    maestroDeOfertaId: '5e6f7a8b-9c0d-1234-efab-567890123456',
  },
  {
  ...
  // Ofertas para Diego
  {
    id: '0d1e2f3a-4b5c-6789-defa-012345678901',
    grupoMateriaId: 'b1c2d3e4-f5a6-7890-abcd-ef1234567891',
    maestroDeOfertaId: '6f7a8b9c-0d1e-2345-fabc-678901234567',
  },
  {
    id: '1e2f3a4b-5c6d-7890-efab-123456789012',
    grupoMateriaId: 'c1d2e3f4-g5h6-7890-abcd-ef1234567890',
    maestroDeOfertaId: '6f7a8b9c-0d1e-2345-fabc-678901234567',
  },
  // Ofertas para Valentina
  {
    id: '2f3a4b5c-6d7e-8901-fabc-234567890123',
    grupoMateriaId: 'f4e5d6c7-b8a9-0b1c-2d3e-4f5a6b7c8d91',
    maestroDeOfertaId: '7a8b9c0d-1e2f-3456-abcd-789012345678',
  },
  {
    id: '3a4b5c6d-7e8f-9012-abcd-345678901234',
    grupoMateriaId: 'a1b2c3d4-e5f6-7890-abcd-ef1234567891',
    maestroDeOfertaId: '7a8b9c0d-1e2f-3456-abcd-789012345678',
  },
];
...
async function main() {
  ...
  await prisma.planDeEstudio.createMany({
  ...
  await prisma.maestroDeOferta.createMany({
    data: maestroDeOferta,
  });
